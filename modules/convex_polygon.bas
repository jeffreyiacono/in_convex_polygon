...
Private Function isToTheRight(pointY As Double, pointX As Double, startY As Double, startX As Double, endY As Double, endX As Double) As Boolean
...
' if the point is to the right of the different line segements when traversed clockwise
'
' In pictures:
'
'                topMost (x,y)
